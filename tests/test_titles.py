...
def test_get_one_post_not_exist(authorized_client, test_titles):
    res = authorized_client.get(f"/posts/88888")
    assert res.status_code == 404


def test_get_one_post(authorized_client, test_titles):
...
@pytest.mark.parametrize("title, show_id, published", [
